...
let changeQuoteBTN = document.getElementById("changeQuote");
let showQuote = document.getElementById("quoteText");
let source = document.getElementById("source");
let citetion = document.getElementById("citetion");
...
function changequote() {
    ...
    let getQuote = quotes[anynumber];
    showQuote.innerHTML = getQuote.quote;

    source.innerHTML = `- ${getQuote.source}`;
    citetion.innerHTML = getQuote.citation ? `- ${getQuote.citation}` : "";
    year.innerHTML = getQuote.year ? `- ${getQuote.year}` : "";
